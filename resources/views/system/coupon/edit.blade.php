...
@section('breadcrumbs')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2><i class="fa fa-list"></i> Cập nhật mã coupon {{ $coupon->code }}</h2>
        </div>
    </div>
@stop
        ...
        <div class="ibox-content m-b-sm border-bottom">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    @include('system/coupon/form_update')
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    $(function() {
        ...
        $('#form-data').on('submit', function(e) {
            ...
            $.ajax({
                url : '{{ route('system.coupon.update', $coupon->id) }}',
                type : "POST",
                data: $form.serialize(),
                dataType: 'json',
