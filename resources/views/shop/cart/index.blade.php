    ...
    <div class="container">
        <div class="row" id="cart">
            <div class="col-xs-12">
                ...
                <a href="javascript:;" id="update-cart" class="btn btn-sm btn-primary">Cập nhật</a>
                <a href="{{ route('shop.cart.clear') }}" class="btn btn-sm btn-danger">Xóa</a>
                <a href="{{ route('shop.submitOrder') }}" class="btn btn-sm btn-info">Thanh toán</a>
            </div>
        </div>
    </div>
</section>
