                        ...
                        <div class="ibox-content">
                                    ...
                                    <div class="profile-info">
                                        <div class="">
                                            <div>
                                                ...
                                                <p style="font-weight:normal;font-size:11px;"><i class="fa fa-envelope"></i> {!! $data_user['email'] !!}</p>
                                                <small>
                            ...
                            <div class="table-responsive" style="overflow-x: inherit;">
                                <table class="table shoping-cart-table">
                                    <tbody>
                                        <form method="GET" action="{!! route('admin.staff.getOrders',$uid) !!}" accept-charset="UTF-8">
                                            <tr>
                                                <td colspan="5"> 
                                                    <p>
...
$(document).ready(function() {
    ...
    $('.sbm-filter-fast').click(function(){
        ...
        if(attr_type == 'order-status'){
            window.location.href = "/system/staff/orders/<?=$uid?>?filter-order-status="+attr_value+"&filter-order-time=<?=$filterFastOrderTime?>";
        }
        if(attr_type == 'order-time'){
            window.location.href = "/system/staff/orders/<?=$uid?>?filter-order-status=<?=$filterFastOrderStatus?>&filter-order-time="+attr_value;
        }
    });
