@extends('layout.admin.landingpage')

@section('title')
Tạo Landing Page :: Bán hàng trực tuyến
@endsection
...
<div id="builder">
    ...
    <div class="container">
        <header class="clearfix header-fix" data-spy="affix" data-offset-top="60" data-offset-bottom="200">

            <a href="#siteSettings" id="siteSettingsButton" class="siteSettingsModalButton btn btn-inverse btn-embossed pull-right" data-siteid="{{ $data['siteData']['site'][0]['id'] }}"><span class="fui-arrow-right"></span> Cài đặt chung</a>
            <a href="#pageSettingsModal" id="pageSettingsButton" class="btn btn-inverse btn-embossed pull-right" data-toggle="modal" data-siteid="{{ $data['siteData']['site'][0]['id'] }}"><span class="fui-arrow-right"></span> Cài đặt trang</a>
            <a href="#previewModal" data-toggle="modal" class="btn btn-inverse btn-embossed pull-right" style="display: none" id="buttonPreview"><span class="fui-window"></span> Xem trước</a>
            ...
            <div class="modes" id="siteBuilderModes">
                <label class="radio primary first" id="modeElementsLabel" data-toggle="tooltip" data-placement="bottom" title="Cho phép bạn thêm, xóa bố cục trên trang.">
                    <input type="radio" name="mode" id="modeBlock" value="block" data-toggle="radio" @if( !isset($data['siteData']) )disabled=""@endif checked="">
                    BLocks
                </label>
                <label class="radio primary first" id="modeContentLabel" data-toggle="tooltip" data-placement="bottom" title="Cho phép bạn sửa nội dung trên trang" style="display: none">
                    <input type="radio" name="mode" id="modeContent" value="content" data-toggle="radio" @if( !isset($data['siteData']) )disabled=""@endif>
                    Nội dung
                </label>
                <label class="radio primary first" id="modeStyleLabel" data-toggle="tooltip" data-placement="bottom" title="Cho phép bạn sửa Url, Link ảnh và Link Video trên trang" style="display: none">
        ...
        <div class="screen" id="screen">
            <div id="frameWrapper" class="frameWrapper empty">
                ...
                <div class="start" id="start" <?php if( isset($data['siteData']['pages']) && count($data['siteData']['pages']) > 0 ):?>style="display:none"<?php endif;?>>
                    <span>Kéo thả BLock để xây dựng nội dung Landing Page</span>
                </div>
            </div>
        </div><!-- /.screen -->
    ...
    <div class="modal fade publishModal" id="publishModal" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <!--<form action="#" target="_blank" id="publishForm" method="post" class="form-horizontal">-->
                                            ...
                                            <tr>
                                                <td class="text-center" style="width: 30px;">
                                                    <label class="checkbox no-label">
                                                        <input checked type="checkbox" value="{{ $folder }}" id="" data-type="asset" name="assetFolders[]" data-toggle="checkbox">
                                                    </label>
                                                </td>
                                                <td>
                                                    {{ $folder }}
                    ...
                    <div class="modal-body-content">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="adminImagesTab">
                                <div class="images" id="adminImages">
...
<div class="modal fade pageSettingsModal" id="pageSettingsModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <h4 class="modal-title" id="myModalLabel"><span class="fui-gear"></span> Cài đặt trang <span class="text-primary pName"></span></h4>
            </div>
            <div class="modal-body">
                <div class="loader" style="display: none;">
                    <img src="{{ URL::to('src/images/loading.gif') }}" alt="Loading...">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-embossed" data-dismiss="modal"><span class="fui-cross"></span> Huỷ &amp; Đóng</button>
                <button type="button" class="btn btn-primary btn-embossed" id="pageSettingsSubmittButton"><span class="fui-check"></span> Lưu thông tin</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<div class="modal fade errorModal" id="errorModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fui-cross"></span> Đóng</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<div class="modal fade" id="previewModal" tabindex="-1" role="dialog" aria-hidden="true">
    <form action="{{ route('live.preview') }}" target="_blank" id="markupPreviewForm" method="post" class="form-horizontal">
        <!--<form action="#" target="_blank" id="markupPreviewForm" method="post" class="form-horizontal">-->
