...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2><i class="fa fa-indent"></i> Chi tiết phiếu trả hàng</h2>
    </div>
    <div class="col-lg-2">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <table class="footable table table-stripped toggle-arrow-tiny table-zip" data-page-size="15">
                            <thead>
                            <tr>
                                <th class="footable-visible footable-first-column footable-sortable">Mã phiếu<span class="footable-sort-indicator"></span></th>
                                <th>Tên phiếu</th>
                                <th>Kho hàng</th>
                                <th width="150" class="text-right">Ngày nhập </th>
                            </tr>
                            </thead>
                            <tbody>
                                <tr class="footable-even" style="display: table-row;">
                                    <td width="180">
                                        {!! $data_warehouse_return_product_ph['code'] !!}
                                    </td>
                                    <td>
                                        {!! $data_warehouse_return_product_ph['name'] !!}
                                    </td>
                                    <td>
                                        {!! $data_warehouse['name'] !!}
                                    </td>
                                    <td align="right">
                                        {!! $data_warehouse_return_product_ph['created_at'] !!}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <ul class="sortable-list connectList agile-list ui-sortable" id="todo">
                            <li class="danger-element" id="task4">
                                ...
                                <div class="agile-detail">
                                    <i class="fa fa-clock-o"></i> {!! $data_warehouse_return_product_ph['created_at'] !!}
                                </div>
                            </li>
                        </ul>
