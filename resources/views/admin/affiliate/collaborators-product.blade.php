                        ...
                        <div class="table-responsive" style="overflow-x: inherit;">
                            <table class="table table-striped table-bordered table-hover table-zip" id="editable" style="font-size:11px;">
                                ...
                                <tr>
                                    ...
                                    <th style="color: #484848;border-color: #7bbf20;" width="70">Lợi nhuận <sup> - vnđ </sup></th>
                                    <th style="color: #484848;border-color: #7bbf20;" width="150">Link Share sản phẩm</sup></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php
