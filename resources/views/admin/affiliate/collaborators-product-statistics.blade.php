...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-9">
        <h2><i class="fa fa-list"></i> Thống kê lợi nhuận thu được trên sản phẩm</h2>
    </div>
</div>
@stop
                                    ...
                                    <div class="ibox-content bg-block">
                                        ...
                                        <table class="table table-stripped m-t-md">
                                            ...
                                            <tr>
                                                ...
                                                <td class="">
                                                    Tổng số lượng sản phẩm đang bán: <span class="text-danger">{!! number_format($total_row) !!}</span> sản phẩm
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="" width="10">
                                                ...
                                                <td class="">
                                                    Tổng số lợi nhuận thu được: <span class="text-danger">{!! number_format($data_total_profit[0]->total_profit) !!}</span> vnđ
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
