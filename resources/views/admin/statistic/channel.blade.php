...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2><i class="fa fa-bar-chart-o"></i> Thống kê, báo cáo theo kênh bán hàng</h2>
    </div>
    <div class="col-lg-2">
                            ...
                            <div class="ibox float-e-margins">
                                <div class="ibox-content mailbox-content">
                                    <table class="table table-striped table-bordered table-hover table-zip" id="editable" >
                                        ...
                                        <tr>
                                            <th width="15">#</th>
                                            <th style="color: #484848;"><b>Kênh bán hàng</b></th>
...
$('.submit-filter').click(function(){
    ...
    window.location.replace("/system/statistic/channel"+get_url);
