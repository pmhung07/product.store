...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2><i class="fa fa-bar-chart-o"></i> Thống kê, báo cáo theo sản phẩm</h2>
    </div>
    <div class="col-lg-2">
                                ...
                                <div class="ibox-content mailbox-content">
                                    <div class="condition">
                                        ...
                                        <ul class="properties-list-conditions condition-folder-list m-b-md" style="padding: 0">
                                            <li>
                                                <input class="form-control search-input-product" style="width:100%;" placeholder="Tìm sản phẩm theo tên, Sku" type="text" value="">
                                            ...
                                            <li>
                                                <select attr-table="channel" class="conditions_channel form-control" style="width:100%;">
                                                    ...
                                                    <?php foreach($channel as $key => $value){ ?>
                                                        <option attr-name="Kênh bán hàng: <?=$value['name']?>" value="<?=$value['id']?>">-- <?=$value['name']?> --</option>
                                                    <?php } ?>
                                                </select>
                                            </li>
                                            <li>
                                                <select attr-table="users" class="conditions_staff form-control" style="width:100%;">
                                                    ...
                                                    <?php foreach($users as $key => $value){ ?>
                                                        <option attr-name="Nhân viên: <?=$value['name']?>" value="<?=$value['id']?>">-- <?=$value['name']?> --</option>
                                                    <?php } ?>
                                                </select>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a style="width:100%;" class="btn btn-sm btn-primary submit-filter"><i class="fa fa-search"></i> Thống kê</a>
                                            </li>
                                        </ul>
                                ...
                                <div class="ibox-content mailbox-content">
                                    <table class="table table-striped table-bordered table-hover table-zip" id="editable" >
                                        ...
                                        <tr>
                                            ...
                                            <th style="color: #484848;"><b>Tổng tiền huỷ</b></th>
                                            <th style="color: #484848;"><b>Tổng tiền thành công</b></th>
                                            <th style="color: #484848;"><b>Tổng tiền hoàn trả</b></th>
                                            <th style="color: #484848;">Tổng tiền</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                            <?php $i=1; ?>
...
$('.submit-filter').click(function(){
    ...
    if( product_id != '' ){
        get_url = get_url + '&conditions_product='+product_id;
    }
    ...
    window.location.replace("/system/statistic/product"+get_url);
