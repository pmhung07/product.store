...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-9">
        <h2><i class="fa fa-rss"></i> Danh sách kênh bán hàng</h2>
    </div>
    <div class="col-lg-3 btn-add">
        <a href="system/channel/create" class="btn btn-primary " ><i class="fa fa-plus"></i>&nbsp;Tạo kênh bán hàng</a>
    </div>
</div>
@stop            
                            ...
                            @foreach($rows as $row)
                                <tr @if($i%2==0) {{'class="gradeA"'}} @else {{'class="gradeX"'}} @endif>
                                    ...
                                    <td class="text-right footable-visible footable-last-column">
                                        <div class="btn-group">
                                            <a href="{!! URL::route('admin.channel.getUpdate',$row->id) !!}" class="btn-white btn btn-xs">
                                                <i class="fa fa-edit "></i> Sửa
                                            </a>
                                            <a href="#" data-toggle="modal" data-target="#confirm-delete" data-href="{!! URL::route('admin.channel.getDelete',$row->id) !!}"  class="btn-white btn btn-xs">
