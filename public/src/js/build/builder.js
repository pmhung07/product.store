    ...
    function Block () {
        ...
        */
        this.createFrameCover = function() {
            ...
            delButton.innerHTML = '<span class="fui-trash"></span> Xoá';
            ...
            if( publish.publishActive === 0 ) {//check if we're currently publishing anything
                ...
                if( siteBuilder.site.pendingChanges === true ) {//we've got changes, save first
                    ...
                    $('#pages li:visible').each(function(){
                        ...
                        var theRow = $('<tr><td class="text-center" style="width: 30px;"><label class="checkbox no-label"><input type="checkbox" checked value="'+thePage+'" id="" data-type="page" name="pages[]" data-toggle="checkbox"></label></td><td>'+thePage+'<span class="publishing"><span class="working">Publishing... <img src="'+appUI.baseUrl+'images/publishLoader.gif"></span><span class="done text-primary">Published &nbsp;<span class="fui-check"></span></span></span></td></tr>');
            ...
            $.ajax({
                ...
                if( res.responseCode === 1 ) {//changes were saved without issues
                    ...
                    $('#pages li:visible').each(function(){
                        ...
                        var thePage = $(this).find('a:first').text();
                        var theRow = $('<tr><td class="text-center" style="width: 0px;"><label class="checkbox"><input type="checkbox" checked value="'+thePage+'" id="" data-type="page" name="pages[]" data-toggle="checkbox"></label></td><td>'+thePage+'<span class="publishing"><span class="working">Publishing... <img src="'+appUI.baseUrl+'images/publishLoader.gif"></span><span class="done text-primary">Published &nbsp;<span class="fui-check"></span></span></span></td></tr>');
